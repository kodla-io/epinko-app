  ...
  return (
    <div id="buy-sell" className="container m-auto">
      <div className="text-[var(--foreground)] p-4 rounded-xl">
        {/* Tabs */}
        <div className="flex space-x-2 mb-6 text-[14px] md:text-md overflow-x-auto scrollbar-hide pb-[10px]">
          <button
        ...
        {activeTab === "hakkinda" && (
          <div className="text-gray-300">
            <h2 className="text-xl font-bold mb-2">Oyun Hakkında</h2>
            <p>
              Knight Online, PvP ağırlıklı MMORPG oyunudur. Oyuncular iki ırktan
              birini seçerek (Karus ya da El Morad), seviye atlayarak ve eşyalar
              toplayarak güçlenir.
            </p>
          </div>
        )}
