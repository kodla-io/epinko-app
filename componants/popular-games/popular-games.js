  ...
  return (
    <div className="container mx-auto py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-14 gap-4 p-4">
        ...
        <div
          ref={cardRef}
          className="col-span-1 md:col-span-1 lg:col-span-3 rounded-lg flex flex-col justify-center items-center relative min-h-[420px] max-h-[420px] poplar-game-card"
        >
          <img
