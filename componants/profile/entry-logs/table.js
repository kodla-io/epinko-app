...
const AdvertData = [
  ...
  },
  {
    ...
    OS: "Macintosh",
    IP: "00.000.0.00",
    process: "Lorem ipsum dolor sit amet, consectetur.",
    date: "25.01.2023",
  },
  {
    no: 3,
...
const headers = [
  ...
  { key: "IP", label: "IP" },
  { key: "process", label: "İşlem" },
  { key: "date", label: "Tarih" },
];

const EntryLogsTable = ({ title }) => {
